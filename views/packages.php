...
if ( empty( $packages ) ) :
	...
	<div class="satispress-card">
		...
		<p>
			<a href="https://github.com/cedaro/satispress/blob/develop/docs/whitelisting.md" target="_blank" rel="noopener noreferer"><em><?php esc_html_e( 'Read more about whitelisting plugins and themes.', 'satispress' ); ?></em></a>
		</p>
